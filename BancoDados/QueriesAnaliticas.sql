...
select Registro_ANS, cnpj, Nome_Fantasia, sum(VL_SALDO_INICIAL), sum(VL_SALDO_FINAL), (sum(VL_SALDO_FINAL) - sum(VL_SALDO_INICIAL)) as despesas from operadorasativas
